    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Impuesto y Transporte</h1>
                ...
                <div class="card shadow mb-4" id="cuadro1">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Reporte por Impuesto y Transporte</h6>
                        <br>
                        <div class="col-md-4">
...
<script>
    $(document).ready(function() {
        ...
        $("#nav_impuesto-transporte, #modulo_Reportes").addClass("active");
    ...
    $("#search").click(function(e){
       ...
       var alamacen =  $("#warehouse").val();
        ...
        var table = $("#table").DataTable({
            ...
            "ajax": {
                "method": "GET",
                "url": '' + url + '/api/impuesto/transporte/'+factura,
                "dataSrc": ""
            },
            "columns": [
                {
