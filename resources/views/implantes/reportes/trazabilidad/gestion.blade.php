	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				<!-- Page Heading -->
				<h1 class="h3 mb-2 text-gray-800">Trazabilidad</h1>
				<div id="alertas"></div>
				...
				<div class="card shadow mb-4" id="cuadro1">
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary">Trazabilidad</h6>
				...
				@include('implantes.reportes.trazabilidad.store')
				@include('implantes.reportes.trazabilidad.view')
				@include('implantes.reportes.trazabilidad.edit')
			</div>
			<!-- /.container-fluid -->
		</div>
		<!-- End of Main Content -->
...
<script>
	$(document).ready(function() {
		...
		$("#nav_trazabilidad, #modulo_Implantes").addClass("active");
	...
	function list(cuadro) {
		...
		var table = $("#table").DataTable({
			...
			"ajax": {
				"method": "GET",
				"url": '' + url + '/api/get/implantes/list/trazabilidad/' + name_rol,
				"dataSrc": ""
			},
			"columns": [
				// {
