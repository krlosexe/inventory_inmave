...
class InvoiceController extends Controller
{
    public function ShowInvoice($id)
    {
        ...
        return $pdf->loadView('invoice.InvoicePdf', $data)
            ->stream('archivo.pdf');
    }
    ...
    public function ShowInvoiceImplantes($id)
    {
    ...
    public function ShowInvoiceReemisionImplantes($id)
    {
        ...
        $data = ImplanteReemision::select(
            ...
            ->with("items")
            ->where("implantes_reemisiones.id", $id)
            ->first();
        ...
        if($data){
            ...
            if($data->warehouse == "Barranquilla"){
                $data->ammount_text =  $this->convertirNumeroLetra($data["total_invoice"]);
                return $pdf->loadView('invoice.InvoicePdfImplante', $data)->stream('archivo.pdf');
            }
