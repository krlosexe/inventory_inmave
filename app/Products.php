...
{
    protected $fillable = [
        'code', 'description', 'register_invima', 'price_euro', 'price_cop','price_cop_iva_imp', 'presentation', 'price_distributor_x_caja', 'price_distributor_x_vial', 'price_cliente_x_caja', 'price_cliente_x_vial'
    ];
